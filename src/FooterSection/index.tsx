...
import GlowButton from "../UIComponents/GlowButton";
...
const FooterSection: React.FC = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0">
      <div className="flex justify-between items-center px-8 py-4 bg-white border-t border-gray-200 rounded-t-[25px]">
        <button className="flex flex-col items-center" onClick={() => navigate('/HomePage')}>
          <svg
            className=" w-5 text-indigo-400"
            width="50%"
            height="50%"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <a className="flex flex-col items-center">
          ...
          <p className="text-indigo-400">Stats</p>
        </a>
      </div>
